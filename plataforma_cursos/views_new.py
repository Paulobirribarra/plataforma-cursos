    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            try:
                ...
                # Datos ya validados del formulario
                nombre = contact_message.nombre
                email = contact_message.email
                telefono = contact_message.telefono
                asunto = contact_message.asunto
                mensaje = contact_message.mensaje
                ...
                return render(request, 'contacto.html', {'form_sent': True, 'form': ContactForm()})
